...
mod foreignc {
    ...
    #[no_mangle]
    unsafe extern "C" fn dict_set_str(
        cr: *mut Record,
        ckey: *const HaruString,
        val: NativeValue,
    ) {
    ...
    #[no_mangle]
    unsafe extern "C" fn dict_is_prototype_of(
        left: *const Record,
        right: *const Record,
    ) -> bool {
        let left = &*left;
    ...
    // #region string
    #[no_mangle]
    unsafe extern "C" fn string_malloc(
        cstr: *mut libc::c_char,
        vm: *const Vm,
    ) -> *mut HaruString {
    ...
    unsafe extern "C" fn string_append(
        cleft: *const HaruString,
        cright: *const HaruString,
        vm: *const Vm,
    ) -> *mut HaruString {
    ...
    #[no_mangle]
    unsafe extern "C" fn string_append_in_place(
        left: *mut HaruString,
        right: *const HaruString,
    ) {
        let left = &mut *left;
        let right = &*right;
    ...
    #[no_mangle]
    unsafe extern "C" fn function_set_bound_var(
        fun: *mut Function,
        slot: u16,
        val: NativeValue,
    ) {
    ...
    // #region array
    #[no_mangle]
    unsafe extern "C" fn array_obj_malloc(
        vm: *const Vm,
    ) -> *mut Vec<NativeValue> {
        (&*vm).malloc(Vec::new()).into_raw()
    }
    #[no_mangle]
    unsafe extern "C" fn array_obj_malloc_n(
        n: usize,
        vm: *const Vm,
    ) -> *mut Vec<NativeValue> {
    ...
    #[no_mangle]
    unsafe extern "C" fn exframe_native_stack_depth(
        selfptr: *const ExFrame,
    ) -> usize {
        let exframe = &*selfptr;
    ...
    // #region modules
    #[no_mangle]
    unsafe extern "C" fn vm_load_module(
        cvm: *mut Vm,
    ...
    // #region value
    #[no_mangle]
    unsafe extern "C" fn vm_get_interned_string(
        cvm: *const Vm,
        i: u16,
    ) -> *mut HaruString {
        let vm = &*cvm;
