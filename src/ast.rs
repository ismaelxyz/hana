...
pub mod ast {
    ...
    pub struct ArrayExpr {
        pub _span: Span,
        pub exprs: Vec<std::boxed::Box<dyn AST>>,
    }
    #[cfg_attr(tarpaulin, skip)]
    ...
    pub struct FunctionDefinition {
        ...
        pub args: Vec<String>,
        pub stmt: std::boxed::Box<dyn AST>,
    }
    #[cfg_attr(tarpaulin, skip)]
    impl fmt::Debug for FunctionDefinition {
        fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
            ...
            let argsv: Vec<String> =
                self.args.iter().map(|x| format!("\"{}\"", x)).collect();
            args += &argsv.join(",");
            args += "]";
            write!(
                f,
    ...
    pub struct RecordDefinition {
        pub _span: Span,
        pub id: Option<String>,
        pub stmts: Vec<std::boxed::Box<dyn AST>>,
    }
    #[cfg_attr(tarpaulin, skip)]
        ...
        fn emit(&self, c: &mut compiler::Compiler) -> CodeGenResult {
            ...
            for stmt in &self.stmts {
                ...
                } else if let Some(stmt) = any.downcast_ref::<RecordStatement>()
                {
                    ...
                    let binexpr =
                        stmt.expr.as_any().downcast_ref::<BinExpr>().unwrap();
                    let id = if let Some(id) =
                        binexpr.left.as_any().downcast_ref::<Identifier>()
                    {
                        id
                    } else {
    ...
    pub struct CondExpr {
        pub _span: Span,
        pub cond: std::boxed::Box<dyn AST>,
        pub then: std::boxed::Box<dyn AST>,
        pub alt: std::boxed::Box<dyn AST>,
    }
    impl CondExpr {
        fn _emit(
            &self,
            c: &mut compiler::Compiler,
            is_tail: bool,
        ) -> CodeGenResult {
            emit_begin!(self, c);
            let _smap_begin = smap_begin!(c);
            ...
            if is_tail {
                if let Some(expr) =
                    self.then.as_any().downcast_ref::<CallExpr>()
                {
                    expr._emit(c, true)?;
                } else if let Some(expr) =
                    self.then.as_any().downcast_ref::<CondExpr>()
                {
                    expr._emit(c, true)?;
                } else {
                    self.then.emit(c)?;
    ...
    pub struct BinExpr {
        pub _span: Span,
        pub left: std::boxed::Box<dyn AST>,
        pub right: std::boxed::Box<dyn AST>,
        pub op: BinOp,
    }
    #[cfg_attr(tarpaulin, skip)]
                ...
                BinOp::Assign => {
                        ...
                        any.downcast_ref::<CallExpr>()
                    {
                        ...
                        for arg in &callexpr.args {
                            c.set_local(
                                if let Some(arg) =
                                    arg.as_any().downcast_ref::<Identifier>()
                                {
                                    arg.val.clone()
                                } else {
                                    return Err(
                                        CodeGenError::ExpectedIdentifier,
                                    );
                                },
                            );
                        }
                        ...
                        c.fill_label16(
                            function_end,
                            (c.clen() - function_end) as u16,
                        );

                        let id = if let Some(id) = &callexpr
                            .callee
                            .as_any()
                            .downcast_ref::<Identifier>(
                        ) {
    ...
    pub struct CallExpr {
        pub _span: Span,
        pub callee: std::boxed::Box<dyn AST>,
        pub args: Vec<std::boxed::Box<dyn AST>>,
    }
    impl CallExpr {
        fn _emit(
            &self,
            ...
            if let Some(memexpr) =
                self.callee.as_any().downcast_ref::<MemExpr>()
            {
    ...
    pub enum CallExprArm {
        MemExprIden(std::boxed::Box<dyn AST>),
        MemExprNs(std::boxed::Box<dyn AST>),
        MemExpr(std::boxed::Box<dyn AST>),
        CallExpr(Vec<std::boxed::Box<dyn AST>>),
    }
    ...
    pub struct IfStatement {
        pub _span: Span,
        pub expr: std::boxed::Box<dyn AST>,
        pub then: std::boxed::Box<dyn AST>,
        pub alt: Option<std::boxed::Box<dyn AST>>,
    }
    #[cfg_attr(tarpaulin, skip)]
    ...
    pub struct ForStatement {
        pub _span: Span,
        pub id: String,
        pub from: std::boxed::Box<dyn AST>,
        pub to: std::boxed::Box<dyn AST>,
        pub step: std::boxed::Box<dyn AST>,
        pub stmt: std::boxed::Box<dyn AST>,
        pub is_up: bool,
    }
    #[cfg_attr(tarpaulin, skip)]
    ...
    pub struct ReturnStatement {
        pub _span: Span,
        pub expr: Option<std::boxed::Box<dyn AST>>,
    }
    #[cfg_attr(tarpaulin, skip)]
            ...
            match &self.expr {
                Some(expr) => {
                    if let Some(expr) = expr.as_any().downcast_ref::<CallExpr>()
                    {
                        ...
                        expr.as_any().downcast_ref::<CondExpr>()
                    {
                        expr._emit(c, true)?;
                    } else {
                        expr.emit(c)?;
    ...
    pub struct CaseStatement {
        pub _span: Span,
        pub etype: std::boxed::Box<dyn AST>,
        pub id: Option<std::boxed::Box<dyn AST>>,
        pub stmts: Vec<std::boxed::Box<dyn AST>>,
    }
    #[cfg_attr(tarpaulin, skip)]
