            ...
            match &ffi_fn.rettype {
                ...
                | FFI_Type::Pointer => {
                    ...
                    ffi_call(
                        &mut ffi_fn.cif,
                        sym,
                        transmute::<&i64, *mut c_void>(&rvalue),
                        aref.as_mut_ptr(),
                    );
                    Value::Int(rvalue)
                }
                FFI_Type::Float32 => {
                    ...
                    ffi_call(
                        &mut ffi_fn.cif,
                        sym,
                        transmute::<&f32, *mut c_void>(&rvalue),
                        aref.as_mut_ptr(),
                    );
                ...
                FFI_Type::Float64 => {
                    ...
                    ffi_call(
                        &mut ffi_fn.cif,
                        sym,
                        transmute::<&f64, *mut c_void>(&rvalue),
                        aref.as_mut_ptr(),
                    );
                    Value::Float(rvalue)
                }
                FFI_Type::String => {
                    ...
                    ffi_call(
                        &mut ffi_fn.cif,
                        sym,
                        transmute::<&*const libc::c_char, *mut c_void>(&rvalue),
                        aref.as_mut_ptr(),
                    );
...
pub fn load(vm: &mut Vm) {
    ...
    set_obj_var!(
        library,
        "constructor",
        Value::NativeFn(library::constructor)
    );
    ...
    set_obj_var!(
        function,
        "constructor",
        Value::NativeFn(function::constructor)
    );
    ...
    set_obj_var!(
        gc_pointer,
        "constructor",
        Value::NativeFn(gc_pointer::constructor)
    );
